        ...
        <tbody>
            @foreach ($menus ?? [] as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('get_admin.menu.update', $item->id) }}" class="btn btn-info" style="padding: 5px">Edit</a>
                        <a href="#">|</a>
                        <a href="{{ route('get_admin.menu.delete', $item->id) }}" class="btn btn-danger" style="padding: 5px">Delete</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
